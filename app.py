...
# --- 1. 核心初始化 ---
st.set_page_config(page_title="AlphaRadar 精簡版", layout="wide")
...
# --- 5. 功能分頁 ---
tabs = st.tabs(["📊 技術圖表", "📡 動能掃描", "🐳 籌碼連動"])

# --- TAB 1: 技術連動 (移除 Subheader 標籤) ---
with tabs[0]:
    # 已根據需求取消行情分析標題標籤
    ...
    if not hist.empty:
        ...
        fig.update_layout(height=700, template="plotly_dark", xaxis_rangeslider_visible=False, hovermode='x unified', margin=dict(t=10))
